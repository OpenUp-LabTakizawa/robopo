  ...
  return (
    <>
      <div className="flex mb-5">
        ...
        <h1 className="text-3xl text-violet-800 font-bold mr-5 mt-2">
          {player?.zekken}
        </h1>
        <h1 className="text-3xl text-violet-800 font-bold mr-5 mt-2">
          {player?.name}
      ...
      <div className="grid justify-end m-5">
        <table className="table table-pin-rows">
          <tbody>
            <tr>
              <td className="border bg-cyan-50 border-gray-400 p-2 text-center">
                一本橋の合計得点
              </td>
      ...
      <div className="grid justify-end m-5">
        <table className="table table-pin-rows">
          <tbody>
            <tr>
              <td className="border bg-cyan-50 border-gray-400 p-2 text-center text-2xl">
                トータルポイント
              </td>
      ...
      <Link
        href={`/summary/` + ids[0]}
        className="btn btn-primary min-w-28 max-w-fit mx-auto mr-5"
      >
        集計結果一覧へ
        <BackLabelWithIcon />
      </Link>
